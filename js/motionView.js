...
document.getElementById("sun").addEventListener("load", function() {
    ...
    var myAttrTween = KUTE.to(sunRayStart, {svgTransform: { rotate: 360, scale: 1.2 }}, {yoyo: true, repeat: Infinity, duration: 5600}).start();
...
document.getElementById("cloud1").addEventListener("load", function() {
    ...
    TweenMax.to(cloud1, 25, {left: '110vw', repeat:Infinity, ease:Quad.easeInOut });
  });
document.getElementById("cloud2").addEventListener("load", function() {
    ...
    tl.to(cloud1, 6, {left: '70vw'});
    tl.to(cloud1, 6, {left: '50vw'});
    tl.to(cloud1, 3, {top: '5vh'});
    tl.to(cloud1, 1, {top: '1vh'});
    tl.to(cloud1, 6, {left: '110vw'});
  });
document.getElementById("cloud3").addEventListener("load", function() {
    ...
    tl.to(cloud1, 10, {left: '40vw', top: '10vh' });
    tl.to(cloud1, 10, {left: '110vw', top: '6vh' });
  });
